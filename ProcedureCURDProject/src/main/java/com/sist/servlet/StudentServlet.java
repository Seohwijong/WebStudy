...
public class StudentServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		out.println("</td>");
		out.println("</tr>");
		out.println("<tr class=dange>");
		out.println("<th class=text-center>학번</th>");
		out.println("<th class=text-center>이름</th>");
		out.println("<th class=text-center>국어점수</th>");
		out.println("<th class=text-center>영어점수</th>");
		out.println("<th class=text-center>수학점수</th>");
		...
		for(StudentVO vo:list)
		{
			...
			out.println("<a href=StudentDelete?hakbun="+vo.getHakbun()+" class=\"btn btn-sm btn-primary\">삭제</a>&nbsp;");
			out.println("</td>");
			out.println("</tr>");
		}
		out.println("</talbe>");
