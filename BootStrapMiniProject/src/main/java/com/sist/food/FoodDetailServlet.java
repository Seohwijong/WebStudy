...
public class FoodDetailServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		FoodVO vo=dao.FoodDetilData(Integer.parseInt(fno));
		...
		// 지도출력 => JSP/ 자바로는 정신나간다 강사님 2022-10-17 webstudy jspfinalproject food_detail 207번째줄  
		out.println("</div>");
		out.println("</div>");
		out.println("</div>");
		out.println("</body>");
...
public class FoodDetailServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		out.println("<a href=\"MainServlet?mode=2&cno="+vo.getCno()+"\"# class=\"btn btn-xs btn-info\">목록</a>"); // 하늘색 btn
		out.println("</td>");
		out.println("</tr>");
		out.println("</table>");
		out.println("</div>");
