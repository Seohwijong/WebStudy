...
<%
	...
	FoodVO vo=dao.foodDetilDate(Integer.parseInt(fno));
...
<script type="text/javascript" src="//dapi.kakao.com/v2/maps/sdk.js?appkey=48c8e26c2aa70d93ca99a338dd735a41&libraries=services"></script>
			...
			<div class="col-sm-7">
				<table class="table">
					...
					<tr>
						...
						<td width=90%>
						<ul>
							<c:forTokens items="${vo.menu }" delims="원" var="m"></c:forTokens>
							<li>${m }원</li>
						</ul>
						</td>
					</tr>
