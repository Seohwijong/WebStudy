...
//			System.out.println(link.toString());
			for(int i=0;i<title.size();i++)
			{
				...
				/*
				 * https://mp-seoul-image-production-s3.mangoplate.com/keyword_search/meta/pictures/kcrp8ki93zu6m6cf.jpg
				 * ?fit=around|600:400&crop=600:400;*,*&output-format=jpg&output-quality=80
				 * 
				 * => & 가 들어가기 때문에 변수 지워짐 => &를 #으로 바꿔줘야함 
				 */
			}
			...
			for(CategoryVO vo:list)
			{
				...
				for(int i=0;i<link.size();i++)
				{
                  ...
                  <p class="branch">방이점</p>
						 ...
						 */
					org.jsoup.nodes.Element name=doc2.selectFirst("span.title h1.restaurant_name");
					org.jsoup.nodes.Element score=doc2.selectFirst("strong.rate-point span");
					/*
					 * </figure></div><div class="owl-item" style="width: 381px;"><figure class="list-photo">
              <meta content="https://mp-seoul-image-production-s3.mangoplate.com/12724/1604891_1684308007564_1000000915?fit=around|512:512&amp;crop=512:512;*,*&amp;output-format=jpg&amp;output-quality=80">
                ...
                <div class="last_image" onclick="trackEvent('CLICK_PICTURE_MORE', {&quot;position&quot;:1,&quot;restaurant_key&quot;:&quot;n4N6o-A4zE&quot;});" ng-click="mp20_gallery_open(5, true)">
                  <p class="txt">
					...
					for(int a=0;a<etc.size();a++)
					{
						...
						if(ss.equals("주소"))
						{
							org.jsoup.nodes.Element e=doc2.select("table.info tr td").get(a);
							addr=e.text();
						}
