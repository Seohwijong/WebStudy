...
//import com.sist.view.RequestDispatcher;
...
public class MainServlet extends HttpServlet {
	...
	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		// 전송타입 (response) => HTML
			    ...
			    out.write("	      <a class=\"navbar-brand\" href=\"MainServlet\">JDBCHJProject</a>");
			    out.write("	    </div>");
			    ...
			    out.write("	        <ul class=\"dropdown-menu\">");
			    out.write("	          <li><a href=\"#\">그룹별 통계</a></li>");
			    out.write("	          <li><a href=\"#\">그룹별 순위</a></li>");
			    out.write("	        </ul>");
			    out.write("	      </li>");
			    out.write("	      ");
			    out.write("	    </ul>");
