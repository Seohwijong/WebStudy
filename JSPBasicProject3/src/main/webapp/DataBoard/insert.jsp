			...
			>
				<table class="table">
					<tr>
						...
						<td width=85%>
							<input type=text name=name class="imput-sm" size=15>
						</td>
					</tr>
					<tr>
						<th class="text-center danger" width=15%>제목</th>
						<td width=85%>
							<input type=text name=subject class="imput-sm" size=50>
						</td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td width=85%>
							<input type=file name=upload class="imput-sm" size=20>
						</td>
					</tr>
					<tr>
						<th class="text-center danger" width=15%>비밀번호</th>
						<td width=85%>
							<input type=password name=pwd class="imput-sm" size=10>
						</td>
					</tr>
					<tr>
