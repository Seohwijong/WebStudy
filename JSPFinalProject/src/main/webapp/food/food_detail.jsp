...
let i=0; // 전역변수
	$(function(){
		$('.ups').click(function(){ // 수정 버튼을 눌렀을때 (<span>)
			$('.updates').hide();
			$('.ups').text("수정");
  ...
  <main class="container clear">
   ...
   <div class="row">
    ...
    <tr>
     ...
     <a href="../food/food_category_list.do?cno=${vo.cno }" class="btn btn-xs btn-info">목록</a>
     </td>
    </tr>
    </table>
    <div style="height: 20px"></div>
    				...
    				<table class="table">
			    		...
			    		<td colspan="2">
				    		<form method=post action="../reply/reply_update.do">
				    			...
				    			<input type=submit value="댓글수정" style="width: 120px;height: 106px;background-color: green;color:white;">
				    		</form>
			    		</td>
				    	</tr>	
    				</table>
    ...
    <table class="table">
    	<tr>
    		...
    		<form method=post action="../reply/reply_insert.do">
    			...
    			<input type=submit value="댓글쓰기" style="width: 120px;height: 106px;background-color: green;color:white;">
    		</form>
    		</td>
    	</tr>	
    </table>
